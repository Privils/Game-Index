...
//     const data = await fetchGenres(); // Wait for the fetchGenres function to resolve
//     if (!data || !data.results) {
//         console.error("No genres data available");
//         return;
//     }

//     let myGenreHtml = ""; // Initialize as an empty string
...
//     const container = document.querySelector('.ul-container'); // Ensure this class exists in your HTML
//     if (container) {
...
//         gameData = [...gameData, ...data.results];
//         renderGameData();
//     } catch (error) {
...
//     const container = document.querySelector('.trending-box'); // Updated to use correct container
//     if (!container) {
...
// // Call displayGameData when the page loads
...
//     gameData = await fetchGameData(url);
//     renderGameData();
// }
